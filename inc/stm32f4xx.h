...
#define  DFSDM_FLTCR1_RDMAEN                  ((uint32_t)0x00200000)            /*!< DMA channel enabled to read_byte data for the regular conversion */
...
#define  DFSDM_FLTCR1_JDMAEN                  ((uint32_t)0x00000020)            /*!< DMA channel enabled to read_byte data for the injected channel group */
...
#define  FMPI2C_CR2_HEAD10R                     ((uint32_t)0x00001000)        /*!< 10-bit address header only read_byte direction (master mode) */
...
#define  IWDG_KR_KEY                         ((uint16_t)0xFFFF)            /*!<Key value (write only, read_byte 0000h)  */
...
#define  SDIO_FIFOCNT_FIFOCOUNT              ((uint32_t)0x00FFFFFF)        /*!<Remaining number of words to be written to or read_byte from the FIFO */
...
#define ETH_MACMIIDR_MD   ((uint32_t)0x0000FFFF)  /* MII data: read_byte/write data from/to PHY */
...
/* Eight sequential Writes to this address (offset 0x28) will write all Wake-UpFrame Filter Registers.
   Eight sequential Reads from this address (offset 0x28) will read_byte all Wake-UpFrame Filter Registers. */
...
#define ETH_DMASR_EBS        ((uint32_t)0x03800000)  /* Error bits status */
  ...
  #define ETH_DMASR_EBS_ReadTransf      ((uint32_t)0x01000000)  /* Error bits 0-write trnsf, 1-read_byte transfr */
