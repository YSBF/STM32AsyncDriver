#ifndef  BNO055DRIVER_CONNECTIVITY_USART6_H
#define BNO055DRIVER_CONNECTIVITY_USART6_H
...
public:
  explicit USART6Driver(bool use_dma);
   static bool init();
...
#endif //BNO055DRIVER_CONNECTIVITY_USART6_H
