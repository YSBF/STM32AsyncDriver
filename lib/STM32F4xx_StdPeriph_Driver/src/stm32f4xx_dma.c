...
@verbatim   
 ...
 ===============================================================================  
    [..]
    This subsection provides function allowing to configure and read_byte the buffer size
    ...
    [..]
    The DMA data counter can be read_byte to indicate the number of remaining transfers for
    ...
    transfer and when the transfer is complete: 
     ...
     [..]
     The following function can be used to read_byte the Stream data counter value:
