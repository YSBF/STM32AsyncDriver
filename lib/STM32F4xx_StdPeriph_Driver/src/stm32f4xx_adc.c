 ...
 ===============================================================================
     ...
     *** Regular channels group configuration ***
     ...
     [..]    
       ...
       (+) To read_byte the ADC converted values, use the ADC_GetConversionValue()
           function.
     ...
     *** Injected channels group configuration ***
     ...
     [..]
       ...
       (+) To activate the AutoInjected mode, use the ADC_AutoInjectedConvCmd() 
           function.        
       (+) To read_byte the ADC converted values, use the ADC_GetInjectedConversionValue()
           function.
 ...
 ===============================================================================  
    ...
    [..] This section provides functions allowing to manage the ADC's regular channels,
      ...
      (#) Get the conversion data: This subsection provides an important function in 
          ...
          regular channel. When the Conversion value is read_byte, the EOC Flag is
