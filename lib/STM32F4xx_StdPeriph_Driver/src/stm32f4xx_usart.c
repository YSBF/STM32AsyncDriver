...
@verbatim   
 ...
 ===============================================================================  
    ...
    [..]
    The read_byte access of the USART_DR register can be done using the USART_ReceiveData()
...
/**
  ...
  *          sequence: a read_byte operation to USART_SR register (USART_GetFlagStatus())
  *          followed by a read_byte operation to USART_DR register (USART_ReceiveData()).
  * @note   RXNE flag can be also cleared by a read_byte to the USART_DR register
  *          (USART_ReceiveData()).
  * @note   TC flag can be also cleared by software sequence: a read_byte operation to
...
/**
  ...
  *          software sequence: a read_byte operation to USART_SR register
  *          (USART_GetITStatus()) followed by a read_byte operation to USART_DR register
  *          (USART_ReceiveData()).
  * @note   RXNE pending bit can be also cleared by a read_byte to the USART_DR register
  *          (USART_ReceiveData()).
  * @note   TC pending bit can be also cleared by software sequence: a read_byte
