...
@verbatim   
 ...
 [..] The following sequence should be followed to configure the FSMC to interface
   ...
   (#) At this stage you can read_byte/write from/to the memory connected to the NOR/SRAM Bank.
...
@verbatim   
 ...
 [..]  The following sequence should be followed to configure the FSMC to interface 
  ...
  (#) At this stage you can read_byte/write from/to the memory connected to the NAND Bank.
...
@verbatim   
 ...
 [..]  he following sequence should be followed to configure the FSMC to interface 
  ...
  (#) At this stage you can read_byte/write from/to the memory connected to the PCCARD Bank.
