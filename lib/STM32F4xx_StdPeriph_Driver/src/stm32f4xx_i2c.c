...
void I2C_Send7bitAddress(I2C_TypeDef* I2Cx, uint8_t Address, uint8_t I2C_Direction)
{
  ...
  /* Test on the direction to set/reset the read_byte/write bit */
  if (I2C_Direction != I2C_Direction_Transmitter)
  {
    /* Set the address bit0 for read_byte */
...
/**
  ...
  * @param  I2C_Register: specifies the register to read_byte.
  *          This parameter can be one of the following values:
  ...
  * @retval The value of the read_byte register.
  */
...
/**
  ...
  *            @arg I2C_FLAG_BERR: Bus error flag
  *   
  * @note   STOPF (STOP detection) is cleared by software sequence: a read_byte operation
  *          to I2C_SR1 register (I2C_GetFlagStatus()) followed by a write operation 
  *          to I2C_CR1 register (I2C_Cmd() to re-enable the I2C peripheral).
  * @note   ADD10 (10-bit header sent) is cleared by software sequence: a read_byte
  *          operation to I2C_SR1 (I2C_GetFlagStatus()) followed by writing the 
  *          second byte of the address in DR register.
  * @note   BTF (Byte Transfer Finished) is cleared by software sequence: a read_byte
  *          operation to I2C_SR1 register (I2C_GetFlagStatus()) followed by a 
  *          read_byte/write to I2C_DR register (I2C_SendData()).
  * @note   ADDR (Address sent) is cleared by software sequence: a read_byte operation to
  *          I2C_SR1 register (I2C_GetFlagStatus()) followed by a read_byte operation to
  *          I2C_SR2 register ((void)(I2Cx->SR2)).
  * @note   SB (Start Bit) is cleared software sequence: a read_byte operation to I2C_SR1
...
/**
  ...
  *          read_byte/write to I2C_DR register (I2C_SendData()).
  * @note   ADDR (Address sent) is cleared by software sequence: a read_byte operation to
  *          I2C_SR1 register (I2C_GetITStatus()) followed by a read_byte operation to
  *          I2C_SR2 register ((void)(I2Cx->SR2)).
  * @note   SB (Start Bit) is cleared by software sequence: a read_byte operation to
