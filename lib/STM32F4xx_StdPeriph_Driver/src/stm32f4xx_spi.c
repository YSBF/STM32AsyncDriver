...
@verbatim   
 ...
 [..] The read_byte access of the SPI_DR register can be done using the SPI_I2S_ReceiveData()
...
@verbatim   
 ...
 [..]
   (@) It is advised not to read_byte the calculated CRC values during the communication.
...
/**
  ...
  * @param  SPIx: where x can be 1, 2, 3, 4, 5 or 6 to select the SPI peripheral.
  * @param  SPI_CRC: specifies the CRC register to be read_byte.
  *          This parameter can be one of the following values:
...
/**
  ...
  *            @arg SPI_FLAG_CRCERR: CRC Error flag.  
  *  
  * @note   OVR (OverRun error) flag is cleared by software sequence: a read_byte
  *          operation to SPI_DR register (SPI_I2S_ReceiveData()) followed by a read_byte
  *          operation to SPI_SR register (SPI_I2S_GetFlagStatus()).
  * @note   UDR (UnderRun error) flag is cleared by a read_byte operation to
  *          SPI_SR register (SPI_I2S_GetFlagStatus()).   
  * @note   MODF (Mode Fault) flag is cleared by software sequence: a read_byte/write
...
/**
  ...
  *          sequence: a read_byte operation to SPI_DR register (SPI_I2S_ReceiveData())
  *          followed by a read_byte operation to SPI_SR register (SPI_I2S_GetITStatus()).
  * @note   UDR (UnderRun Error) interrupt pending bit is cleared by a read_byte
  *          operation to SPI_SR register (SPI_I2S_GetITStatus()).   
  * @note   MODF (Mode Fault) interrupt pending bit is cleared by software sequence:
  *          a read_byte/write operation to SPI_SR register (SPI_I2S_GetITStatus())
