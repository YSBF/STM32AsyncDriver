 ...
 ===============================================================================
    [..]
      ...
      (+) void FLASH_SetLatency(uint32_t FLASH_Latency)
          To correctly read_byte data from FLASH memory, the number of wait states (LATENCY)
    ...
    [..]   
     Any operation of erase or program should follow these steps:
      ...
      (#) Call one or several functions to program the desired Option Bytes:
        ...
        (++) void FLASH_OB_RDPConfig(uint8_t OB_RDP) => to set the desired read_byte
             Protection Level
        (++) void FLASH_OB_UserConfig(uint8_t OB_IWDG, uint8_t OB_STOP, uint8_t OB_STDBY) 
...
/**
  ...
  *         1 Mb of the Flash  
  *
  * @note   When the memory read_byte protection level is selected (RDP level = 1),
...
/**
  ...
  * @note   This function can be used only for STM32F42xxx/43xxx devices.
  *   
  * @note   When the memory read_byte out protection is selected (RDP level = 1),
  *         it is not possible to program or erase the flash sector i if CortexM4  
  *         debug features are connected or boot code is executed in RAM, even if nWRPi = 1 
  * @note   Active value of nWRPi bits is inverted when PCROP mode is active (SPRMOD =1).      
  * 
...
/**
  ...
  *         and WRPi = 1 (default value), then the user sector i is read_byte/write protected.
  ...
  *            @arg OB_PcROP_Enable: nWRPi control the  read_byte&write protection (PCROP) of respective user sectors.
  * @retval None
  */
...
/**
  * @brief  Enables or disables the read_byte/write protection (PCROP) of the desired
  ...
  *   
  * @param  OB_PCROP: specifies the sector(s) to be read_byte/write protected or unprotected.
  *          This parameter can be one of the following values:
...
/**
  * @brief  Sets the read_byte protection level.
  * @param  OB_RDP: specifies the read_byte protection level.
  *          This parameter can be one of the following values:
