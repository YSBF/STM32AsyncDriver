...
@verbatim   
 ...
 ===============================================================================  
  ...
  transmitted.
  [..]
  The read_byte access of the SAI_xDR register can be done using the SAI_ReceiveData()
...
@verbatim   
  ...
  *** Polling Mode ***
  ...
  In Polling Mode, the SAI communication can be managed by 7 flags:
     (#) SAI_FLAG_FREQ : to indicate if there is a FIFO Request to write or to read_byte.
  ...
  *** Interrupt Mode ***
  ...
  and 7 pending bits: 
  (+) Pending Bits:
     (##) SAI_IT_FREQ : to indicate if there is a FIFO Request to write or to read_byte.
  ...
  *** DMA Mode ***
  ...
  read_byte or to write into the SAI_xDR register (to hit the internal FIFO).
