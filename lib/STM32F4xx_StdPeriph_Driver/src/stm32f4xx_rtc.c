 ...
 *** Time and Date configuration ***
 ...
 [..] 
   ...
   (+) To read_byte the RTC Calendar, use the RTC_GetTime() and RTC_GetDate() functions.
 ...
 *** Alarm configuration ***
 ...
 [..]
   ...
   (+) To read_byte the RTC Alarm, use the RTC_GetAlarm() function.
   (+) To read_byte the RTC alarm SubSecond, use the RTC_GetAlarmSubSecond() function.
 ...
 *** RTC Wakeup configuration ***
 ...
 [..] 
   ...
   (+) To read_byte the RTC WakeUp Counter register, use the RTC_GetWakeUpCounter()
       function.
 ...
 *** TimeStamp configuration ***
 ...
 [..]
   ...
   (+) To read_byte the RTC TimeStamp Time and Date register, use the RTC_GetTimeStamp()
       function.
   (+) To read_byte the RTC TimeStamp SubSecond register, use the
 ...
 *** Backup Data Registers configuration ***
 ...
 [..]
   (+) To write to the RTC Backup Data registers, use the RTC_WriteBackupRegister()
       function.  
   (+) To read_byte the RTC Backup Data registers, use the RTC_ReadBackupRegister()
       function.
...
@verbatim   
 ...
 [..] This section provide functions allowing to initialize and configure the RTC
   ...
   (#) To read_byte the calendar through the shadow registers after Calendar initialization,
...
/**
  ...
  *         RTC_WriteProtectionCmd(DISABLE) before calling this function. 
  * @note   To read_byte the calendar through the shadow registers after Calendar
...
@verbatim   
 ...
 [..] This section provide functions allowing to program and read_byte the RTC Calendar
      (Time and Date).
...
void RTC_GetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  ...
  /* Fill the structure fields with the read_byte parameters */
...
@verbatim   
 ...
 [..] This section provide functions allowing to program and read_byte the RTC Alarms.
...
/**
  ...
  *            @arg RTC_Format_BIN: Binary data format 
  *            @arg RTC_Format_BCD: BCD data format
  * @param  RTC_Alarm: specifies the alarm to be read_byte.
  *          This parameter can be one of the following values:
  *            @arg RTC_Alarm_A: to select Alarm A
  *            @arg RTC_Alarm_B: to select Alarm B  
...
void RTC_GetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  ...
  /* Fill the structure with the read_byte parameters */
...
@verbatim   
 ...
 [..] This section provide functions allowing to program and read_byte the RTC WakeUp.
                                      ...
                                      RTC_DateTypeDef* RTC_StampDateStruct)
{
  ...
  /* Fill the Time structure fields with the read_byte parameters */
  RTC_StampTimeStruct->RTC_Hours = (uint8_t)((tmptime & (RTC_TR_HT | RTC_TR_HU)) >> 16);
  RTC_StampTimeStruct->RTC_Minutes = (uint8_t)((tmptime & (RTC_TR_MNT | RTC_TR_MNU)) >> 8);
  RTC_StampTimeStruct->RTC_Seconds = (uint8_t)(tmptime & (RTC_TR_ST | RTC_TR_SU));
  RTC_StampTimeStruct->RTC_H12 = (uint8_t)((tmptime & (RTC_TR_PM)) >> 16);  

  /* Fill the Date structure fields with the read_byte parameters */
