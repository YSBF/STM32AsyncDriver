      ...
      if (stat_s8 == BNO055_SUCCESS) {
        ...
        if (pg_stat_s8 == BNO055_SUCCESS) {
          ...
          if ((gyro_bw_u8 == BNO055_INIT_VALUE || gyro_bw_u8 > BNO055_INIT_VALUE) &&
            ...
            switch (gyro_bw_u8) {
            case BNO055_GYRO_BW_523HZ:gyro_bw_u8 = BNO055_GYRO_BW_523HZ;
              break;
            case BNO055_GYRO_BW_230HZ:gyro_bw_u8 = BNO055_GYRO_BW_230HZ;
              break;
            case BNO055_GYRO_BW_116HZ:gyro_bw_u8 = BNO055_GYRO_BW_116HZ;
              break;
            case BNO055_GYRO_BW_47HZ:gyro_bw_u8 = BNO055_GYRO_BW_47HZ;
              break;
            case BNO055_GYRO_BW_23HZ:gyro_bw_u8 = BNO055_GYRO_BW_23HZ;
              break;
            case BNO055_GYRO_BW_12HZ:gyro_bw_u8 = BNO055_GYRO_BW_12HZ;
              break;
            case BNO055_GYRO_BW_64HZ:gyro_bw_u8 = BNO055_GYRO_BW_64HZ;
              break;
            case BNO055_GYRO_BW_32HZ:gyro_bw_u8 = BNO055_GYRO_BW_32HZ;
              break;
            default:break;
            }
            com_rslt = p_bno055->BNO055_BUS_READ_FUNC(p_bno055->dev_addr,
      ...
      if (stat_s8 == BNO055_SUCCESS) {
        ...
        if (pg_stat_s8 == BNO055_SUCCESS) {
          ...
          if ((gyro_power_mode_u8 == BNO055_INIT_VALUE || gyro_power_mode_u8 > BNO055_INIT_VALUE) &&
            ...
            case BNO055_GYRO_POWER_MODE_NORMAL:gyro_power_mode_u8 = BNO055_GYRO_POWER_MODE_NORMAL;
              break;
            case BNO055_GYRO_POWER_MODE_FASTPOWERUP:gyro_power_mode_u8 = BNO055_GYRO_POWER_MODE_FASTPOWERUP;
              break;
            case BNO055_GYRO_POWER_MODE_DEEPSUSPEND:gyro_power_mode_u8 = BNO055_GYRO_POWER_MODE_DEEPSUSPEND;
              break;
            case BNO055_GYRO_POWER_MODE_SUSPEND:gyro_power_mode_u8 = BNO055_GYRO_POWER_MODE_SUSPEND;
              break;
            case BNO055_GYRO_POWER_MODE_ADVANCE_POWERSAVE:com_rslt = bno055_get_gyro_bw(&gyro_bw_u8);
              com_rslt += bno055_get_gyro_auto_sleep_durn(&gyro_auto_sleep_durn);
              if (com_rslt == BNO055_SUCCESS) {
                com_rslt += bno055_gyro_set_auto_sleep_durn(gyro_auto_sleep_durn, gyro_bw_u8);
              }
    ...
    if ((stat_s8 == BNO055_SUCCESS) || (p_bno055->page_id == BNO055_PAGE_ONE)) {
      ...
      case BNO055_ACCEL_ANY_MOTION_NO_MOTION_Z_AXIS:
        ...
        *data_u8 = BNO055_GET_BITSLICE(data_u8r, BNO055_ACCEL_ANY_MOTION_Z_AXIS);
        break;
      default:com_rslt = BNO055_OUT_OF_RANGE;
        break;
      }
    } else {
      com_rslt = BNO055_ERROR;
